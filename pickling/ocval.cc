...
case'F':return T(M(u.F)); case'D':return T(M(u.D)); case'q':{int_n*qp=(int_n*)&u.q; return T(*qp);} case'Q':{int_un*qp=(int_un*)&u.Q;return T(*qp);}}

#define VALSWITCHME2(T) switch(tag) { case's':return T(u.s);case'S':return T(u.S);case'i':return T(u.i);case'I':return T(u.I);\
case'l':return T(u.l);case'L':return T(u.L);case'x':return T(u.x);case'X':return T(u.X);case 'b':return T(u.b); case'f':return T(u.f);case'd':return T(u.d); \
case'F':return T(u.F.re, u.F.im); case'D':return T(u.D.re, u.D.im); case'q':{int_n*qp=(int_n*)&u.q;return T(real_8(int_8(*qp)));} case'Q':{int_un*qp=(int_un*)&u.Q;return T(real_8(int_u8(*qp)));} }
...
OC_INLINE Val::operator ALLOW_SIZE_T () const 
{ 
  VALSWITCHME(int_u8,mag2); 
  CREATEVALOPBODY(int_u8);  // Same bits of int_u1 and int_1
}
...
OC_INLINE Val& Val::operator[] (int_n  ii) { return ValLookUpBody_(*this,ii);}
OC_INLINE Val& Val::operator[] (int_un ii) { return ValLookUpBody_(*this,ii);}
...
OC_INLINE Val& Val::operator() (int_n  ii) const { return ValLookUpBodyThrow_(*this,ii);}
OC_INLINE Val& Val::operator() (int_un ii) const { return ValLookUpBodyThrow_(*this,ii);}
...
OC_INLINE ostream& PrintArray (ostream& os, const Array<T>& a)
{
  ...
  return os << "], '" << OCTagToNumeric(TagFor((T*)0)) << "')";
}
...
OC_INLINE ostream& operator<< (ostream& os, const Val& v)
{
  ...
  case 'X': os << v.u.X; break;
  case 'q': { int_n* temp = (int_n*)&v.u.q; os << (*temp); break; }
  case 'Q': { int_un* temp = (int_un*)&v.u.Q; os << (*temp); break; }
...
#endif
  case 'a': { OCString *s = (OCString*)&v.u.a; os << Image(*s, true);  break; }
