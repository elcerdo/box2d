...
void MidasSocket_::installSIGPIPE_ignore ()
{
...
bool MidasSocket_::dataReady_ (int read_fd, Val timeout_in_seconds)
{
...
int MidasSocket_::mySelect_ (int nfds, 
...
// gethostbyname_r
struct hostent MidasSocket_::getHostByNameThreadSafe_ (const string& hostname,
...
void MidasSocket_::setblocking_ (int fd, Val timeout)
{
...
PTOOLS_BEGIN_NAMESPACE 
int MidasSocket_::nonBlockingConnect_ (int* fdp, struct sockaddr_in* addr,
...
void MidasSocket_::helpOpenSocket_ (int domain, int type, int protocol,
...
// To avoid the excessing M2k isms from polluting this, we try to put it all
// here
